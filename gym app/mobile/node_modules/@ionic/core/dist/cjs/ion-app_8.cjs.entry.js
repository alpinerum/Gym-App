...
const index = require('./index-44d397da.js');
const hardwareBackButton = require('./hardware-back-button-c8e15834.js');
const index$1 = require('./index-5915f9b3.js');
const ionicGlobal = require('./ionic-global-76e8c0ab.js');
...
const index$3 = require('./index-74e0fcb9.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-6e71b616.js'); }).then((module) => module.startStatusTap());
                }
                ...
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-c8e15834.js'); });
